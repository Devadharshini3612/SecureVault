...
public class CachedCredentialService {
     ...
     */
    public CachedCredentialService(
     ...
     */
    public CredentialResponse createCredential(CreateCredentialRequest request) throws Exception {
        try {
     ...
     */
    public CredentialResponse getCredentialById(Long credentialId, Long userId) throws Exception {
        try {
            // ALWAYS get full credential data from database for security
            // Sensitive data is never cached
            CredentialResponse credential = credentialService.getCredential(credentialId, userId);
     ...
     */
    public CredentialResponse updateCredential(Long credentialId, Long userId, UpdateCredentialRequest request) throws Exception {
        try {
            // Update credential using original service
            CredentialResponse updatedCredential = credentialService.updateCredentialWithResponse(credentialId, userId, request);
    ...
    public void deleteCredential(Long credentialId, Long userId) throws Exception {
        try {
     ...
     */
    public Map<Category, Integer> getCredentialCountsByCategory(Long userId) throws Exception {
        try {
            // Check cache first
