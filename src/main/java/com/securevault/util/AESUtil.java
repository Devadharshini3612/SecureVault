 ...
 * - The SECRET_KEY should be stored in environment variables or a secure vault
 * - NEVER hardcode the key in production code
 * - For this learning assignment, we're using a fixed key for simplicity
 *
...
public class AESUtil {
     ...
     *
     * ⚠️ LEARNING ASSIGNMENT ONLY ⚠️
     * This is a fixed 256-bit key encoded in Base64.
     * In production, use:
     * - Environment variable: System.getenv("AES_SECRET_KEY")
     * - AWS Secrets Manager
     * - Azure Key Vault
     * - HashiCorp Vault
     *
     * To generate a new secure key, use the generateKey() method.
     */
    private static final String SECRET_KEY = "YXNkZmFzZGZhc2RmYXNkZmFzZGZhc2Rm"; // Base64 encoded 32-byte key
