...
public class PerformanceMonitoringController {
     ...
     * 
     * Warning: Benchmark service temporarily disabled
     */
    @PostMapping("/benchmark")
    public ResponseEntity<ApiResponse<String>> runBenchmark() {
        return ResponseEntity.ok(
            ApiResponse.success("Benchmark feature temporarily disabled", 
                "Use performance metrics endpoints for monitoring")
        );
    }
