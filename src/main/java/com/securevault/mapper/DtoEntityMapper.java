...
public class DtoEntityMapper {
    ...
    public PasswordStrengthResponse toPasswordStrengthResponse(String password, int score, String rating, List<String> feedback) {
        ...
        PasswordStrengthResponse.PasswordAnalysis analysis = createPasswordAnalysis(password);
        
        return new PasswordStrengthResponse(password, score, rating, feedback, analysis);
    }
    ...
    public PasswordGeneratorResponse toPasswordGeneratorResponse(String password, int length, int strength, boolean uppercase, boolean lowercase, boolean digits, boolean special) {
        ...
        return new PasswordGeneratorResponse(password, length, strength, config);
    }
    ...
    public PasswordGeneratorResponse toPasswordGeneratorResponse(List<String> passwords, int length, boolean uppercase, boolean lowercase, boolean digits, boolean special) {
        ...
        return new PasswordGeneratorResponse(passwords, length, config);
    }
    ...
    public PinGeneratorResponse toPinGeneratorResponse(String pin) {
        ...
        return new PinGeneratorResponse(pin);
    }
    ...
    /**
     * Create detailed password analysis for strength response
     */
    private PasswordStrengthResponse.PasswordAnalysis createPasswordAnalysis(String password) {
        if (password == null) {
            return null;
        }
        ...
        boolean hasSpecialChars = password.chars().anyMatch(ch -> !Character.isLetterOrDigit(ch));
        
        // Simple checks for repeated and sequential characters
        boolean hasRepeatedChars = hasRepeatedCharacters(password);
        boolean hasSequentialChars = hasSequentialCharacters(password);
        
        return new PasswordStrengthResponse.PasswordAnalysis(
            password.length(),
            hasUppercase,
            hasLowercase,
            hasDigits,
